...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      ...
      max={max}
      className={cn(
        "relative flex h-5 w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col",
        className
      )}
      {...props}
    >
